...
<strong><span style="color:rgb(0, 176, 80)">Token</span></strong>: means a peice of text generated by breaking raw text into smaller units, can be whole word, part of word, single character, or even a penctuation.
_tokenization done using an algorithmic function differs from model to another._ 
