...
- [[#2. Data Types|2. Data Types]]
	- [[#2. Data Types#🔤 Strings|🔤 Strings]]
	- [[#2. Data Types#✅ Booleans|✅ Booleans]]
	- [[#2. Data Types#🔢 Numbers|🔢 Numbers]]
	- [[#2. Data Types#📋 Arrays|📋 Arrays]]
	- [[#2. Data Types#🗂️ Objects|🗂️ Objects]]
	- [[#2. Data Types#🔣 Symbols|🔣 Symbols]]
	- [[#2. Data Types#💬 Comments|💬 Comments]]
- [[#3. Statements & Conditions|3. Statements & Conditions]]
	- [[#3. Statements & Conditions#`if / else if / else`|`if / else if / else`]]
	- [[#3. Statements & Conditions#Ternary Operator|Ternary Operator]]
	- [[#3. Statements & Conditions#`switch`|`switch`]]
	- [[#3. Statements & Conditions#Loops|Loops]]
- [[#4. JavaScript Semantics|4. JavaScript Semantics]]
	- [[#4. JavaScript Semantics#Truthy & Falsy|Truthy & Falsy]]
	- [[#4. JavaScript Semantics#`==` vs `===`|`==` vs `===`]]
	- [[#4. JavaScript Semantics#`null` vs `undefined`|`null` vs `undefined`]]
	- [[#4. JavaScript Semantics#Type Coercion|Type Coercion]]
	- [[#4. JavaScript Semantics#Scope|Scope]]
- [[#Functions Syntax|Functions Syntax]]
- [[#Basic Operations|Basic Operations]]
	- [[#Basic Operations#Integer ÷ Integer|Integer ÷ Integer]]
	- [[#Basic Operations#Float ÷ Integer|Float ÷ Integer]]
	- [[#Basic Operations#Integer ÷ Float|Integer ÷ Float]]
	- [[#Basic Operations#Float ÷ Float|Float ÷ Float]]
...
- [[#2. `ReferenceError` — Never Declared At All|2. `ReferenceError` — Never Declared At All]]
	- [[#2. `ReferenceError` — Never Declared At All#`undefined` vs `ReferenceError` — Side by Side|`undefined` vs `ReferenceError` — Side by Side]]
...
- [[#4. `null` vs `undefined` — The Eternal Confusion|4. `null` vs `undefined` — The Eternal Confusion]]
	- [[#4. `null` vs `undefined` — The Eternal Confusion#Equality trap:|Equality trap:]]
- [[#5. Strings + Numbers — JavaScript's Revenge|5. Strings + Numbers — JavaScript's Revenge]]
	- [[#5. Strings + Numbers — JavaScript's Revenge#The `+` operator — the traitor|The `+` operator — the traitor]]
	- [[#5. Strings + Numbers — JavaScript's Revenge#Other operators — surprisingly fine|Other operators — surprisingly fine]]
- [[#6. Use Explicit Conversions — The Right Way|6. Use Explicit Conversions — The Right Way]]
	- [[#6. Use Explicit Conversions — The Right Way#String → Number|String → Number]]
	- [[#6. Use Explicit Conversions — The Right Way#Number → String|Number → String]]
	- [[#6. Use Explicit Conversions — The Right Way#Safe math with string numbers|Safe math with string numbers]]
